          ...
          <div className="row">
            ...
            <div>
              ...
              <p style={styles.paragraph}>
                ...
                Although Apple is not a party to this Mobile Addendum, Apple has
                the right to enforce the mobile addendum against you as a third
                party beneficiary relating to your use of the TourGai IOS Apps
              </p>
            </div>
            <div>
              ...
              <p style={styles.paragraph}>
                ...
                we collect your nickname, mobile number, and a password. You can
                further refine and populate your profile with additional
                information such as in the description part when you editing
                your profile.
              </p>
            </div>
            <div>
            ...
            <div>
              ...
              <li style={styles.list}>
                ...
                users of TourGai will not be able to find you. What's more,
              ...
              <li style={styles.list}>
                ...
                retains it. Even after you delete Shared Information, it may
                still be separately cached, copied, or stored by, or remain
                public through, other users or third parties who are not
                affiliated with and not controlled by us. -Where you have
                requested that we erase your Personal Information that we have
                made public and there are grounds for erasure, we will use
                reasonable steps try to tell others that are displaying the
            ...
            <div>
              ...
              <p style={styles.paragraph}>
                ...
                "sensitive" and is subject to stricter regulation than other
                types of Personal Information. Please note that content and
                information that you input to TourGai, such as photographs or
                information about your school or social activities, may reveal
                your sensitive Personal Information to others. Before
                communicating any Personal Information of a sensitive nature
                within TourGai, please consider whether it is appropriate to do
                so.
              </p>
            </div>
            <div>
            ...
            <div>
              <p style={styles.paragraph}>
                ...
                privacy, or administrative-related communications). We send
                these to your email address or via SMS. You may not opt-out of
                these service-related announcements, which are not promotional
                in nature and used solely to protect your account and keep you
              ...
              <p style={styles.paragraph}>
                ...
                media features within TourGai (such as "plug-ins" (which create
                a direct link between two websites) and "widgets" (which are
                provide third party services within TourGai)) allow you to
                re-post and disclosure Shared Information. Any information you
                distribute using such features may be read, collected, and used
              ...
              <p style={styles.paragraph}>
                ...
                delete your TourGai account, your information is deleted within
                60 days of the latter of verification of account ownership and
              ...
              <p style={styles.paragraph}>
                ...
                will response in 24 hours. meanwhile, you can also block that
                user to blacklist to stop more abuses from him/her. What are
              ...
              <p style={styles.paragraph}>
                ...
                app on an iPhone, ipod Touch, iPad or other Apple device that
              ...
              <p style={styles.paragraph}>
                ...
                indemnification by application law, TourGai, not Apple, shall be
              ...
              <p style={styles.paragraph}>
                ...
                for addressing any such claims, which may include, but are not
                limited to: i. any product liability claim. ii. any claim that
                the TourGai IOS App fail to conform to any applicable legal or
                regulatory requirement; and iii. any claim arising under
                consumer protection or similar legislation. Nothing in this
